...
export default function Testimonial({children,image, name, companyName, position, ...rest}){
    return(
        <>
                <div className={TestimonialCSS.layout}>
                    <img src={image} className={TestimonialCSS.image}/>
